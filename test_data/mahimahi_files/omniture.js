/****************************************************************** 
*	This file is ONLY used for the m.epicurious.com mobile site 
******************************************************************* 
*/
...
CN.stats.omniture = (function() {
    ...
    var s_account = "condenet-epicurious",
        server = "stats.epicurious.com",
        secureServer = "sstats.epicurious.com",
        internalFilters = "javascript:,epicurious.com",
        httpStatus = 200;
    ...
    function setPageName() {
        ...
        } else if(CN.url.path()[0] == "recipes"){
        
        	/***  This is needed to send the url correctly for recipe pages. Noramlly this is done in the s_code file and 
 			*     on the serverside but the mobile site doesn't not have a backend interface.
			*/
        	tempPageName = location.protocol + "//"+ location.host +"/"+ CN.url.path()[0] +"/"+ CN.url.path()[1] +"/"+ CN.url.path()[2];
    ...
    *    */
    ...
    return {
        ...
        */
        ...
        doPlugins: function(s) {
            ...
            if(s.kwdP){
                s.eVar33=(s.getQueryParam('mbid')||s.getQueryParam('nav')||s.getQueryParam('fb_ref'))?"Marketing":"Natural Search";
            }
    ...
    if(!s.isReferrer&&!s.campaign&&s.pdvalue === 1) {
        ...
        init: function() {
            ...
            s.linkTrackEvents="event3,event4,event10,event11,event12,event13,event20,event21,event22,event23,event24,event25,event29,event30,event31,event32";
